...
const schemas = [
  {
    ...
    fields: [
      ...
      text("内容主题", "本条视频的内容主线"),
      select("当前阶段", ["项目初始化","书目与来源核验","文案审核","风格样图审核","背景图与分镜审核","配音与字幕制作","时间轴与混音","成片与封面交付","发布与归档","流程结束"], "当前所处生产阶段"),
    ...
    records: [
      {"书名":"允许一切发生","项目ID":"BK-20260719-001","作者":"李梦霁","内容主题":"尊重过往，允许人生松弛地发生","当前阶段":"成片与封面交付","进度":90,"工作状态":"待发布","当前待确认":"","确认负责人":"系统","文案状态":"已完成","风格样图状态":"已完成","分镜图状态":"已完成","配音状态":"已完成","字幕状态":"已完成","成片状态":"已完成","质检结果":"PASS","发布状态":"未发布","发布平台":"微信视频号","成片时长(秒)":54,"工作目录":"E:/BaiduNetdiskWorkspace/电脑其他文件同步/视频号/AI视频/work/2026-07-19-allow-everything-01","成片路径":"E:/BaiduNetdiskWorkspace/电脑其他文件同步/视频号/AI视频/work/2026-07-19-allow-everything-01/remix.mp4","下一步动作":"如需上传视频号平台草稿，请明确指定账号","阻塞与风险":"","最近更新":1752949168000,"数据来源":"delivery-manifest.json；validation-report.json；script_sources.md"},
      {"书名":"兜底","项目ID":"BK-20260719-002","作者":"晴山","内容主题":"能力在行动中生长，为自己的人生兜底","当前阶段":"文案审核","进度":25,"工作状态":"待用户确认","当前待确认":"确认文案 v2","确认负责人":"用户","文案状态":"待确认","风格样图状态":"待确认","分镜图状态":"待确认","配音状态":"未开始","字幕状态":"未开始","成片状态":"未开始","质检结果":"未开始","发布状态":"未发布","发布平台":"微信视频号","工作目录":"E:/BaiduNetdiskWorkspace/电脑其他文件同步/视频号/AI视频/work/2026-07-19-兜底-01","成片路径":"","下一步动作":"先确认 script.txt；未确认前停止配音和后续制作","阻塞与风险":"文案未确认却已生成样图和 9 张分镜图，属于越过门禁","最近更新":1752949168000,"数据来源":"script_sources.md；storyboard.json；storyboard/images/"}
    ],
  ...
  },
  {
    ...
    records: [
      ...
      {"当前阶段":"成片与封面交付","进度权重":90,"阶段出口条件":"成片、封面和质检报告已登记","确认性质":"系统质检"},
...
const gateDefinitions = [
  [1,"书目信息与引用核验","系统质检","研究完成"],[2,"文案确认","用户确认","生成分镜"],[3,"风格样图确认","用户确认","批量生成背景图"],[4,"背景图与分镜审核","用户确认","生成配音"],[5,"配音字幕与技术质检","系统质检","生成成片与封面"],[6,"成片与视频号封面交付","系统记录","安排发布"],[7,"发布确认","用户确认","正式发布"],[8,"发布结果与归档","系统记录","流程结束"]
];
const allowGateStatus = [
  ["已通过","系统","script_sources.md","来源与书目信息已记录"],["已完成（倒推）","用户","script.txt","缺独立确认记录"],["已完成（倒推）","用户","storyboard/images/","缺独立确认记录"],["已完成","用户","storyboard/image-validation.md","已有 12 个正式镜头"],["已通过","系统","voice/voice-validation.md；字幕文件","配音与双语字幕已完成"],["已通过","系统","remix.mp4；validation-report.json","成片、封面和质检报告已登记"],["未开始","用户","","明确要求后才上传平台草稿或发布"],["未开始","系统","final/","当前 final/ 为空"]
];
