...
- When a recurring female protagonist is semantically suitable, default to an adult East Asian woman with shoulder-length softly wavy black hair, minimal makeup, an oatmeal-beige long coat and a slate-blue-gray scarf. Keep face, age, hairstyle, coat and scarf consistent. Change identity or wardrobe only when the narration requires it.
...
```text
same adult East Asian woman across the sequence, shoulder-length softly wavy black hair, minimal makeup, oatmeal-beige long coat, slate-blue-gray scarf, natural body proportions and restrained expression; preserve facial identity, age, hairstyle, coat and scarf colors.
```
...
- recurring character face, age, hair, beige coat or slate-blue scarf drifts without a narration reason;
